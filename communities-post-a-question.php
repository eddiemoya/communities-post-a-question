<?php /*
Plugin Name: Post A Question Widget
 ...
 */    
class Post_A_Question extends WP_Widget {
     ...
     * @var string [REQUIRED]
     */
    var $widget_name = 'Post A Question';
     ...
     * @var string [OPTIONAL]
     */
    private $description = 'Post A Question';
     ...
     * @var string [OPTIONAL]
     */
    private $classname = 'post-your-question';
    ...
    public function widget( $args, $instance ){
        ...
        echo $before_widget;
        get_template_part('widgets/post-a-question');
        echo $after_widget;
...
Post_A_Question::register_widget();